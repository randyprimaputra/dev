...
<template>
    <aside id="sidebar" v-show="isSidebarOpen" @click="isSidebarOpen = false"
        class="fixed top-0 left-0 z-20 flex-col flex-shrink-0 w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width hidden">
        <div
            class="relative flex flex-col flex-1 h-full pt-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          " data-popper-placement="top">
            ...
            margin: 0px;
            transform: translate(184px, 612px);
